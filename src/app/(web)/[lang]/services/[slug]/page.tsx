...
import { fetchServiceData } from '@/data/fetch-services'
    ...
    <div className='py-12'>
      <div className='relative flex h-[400px] items-center justify-center overflow-hidden rounded-bl-[48px] rounded-tr-[48px]'>
        ...
        <div className='relative mx-auto max-w-4xl overflow-hidden rounded-bl-3xl rounded-tr-3xl bg-base-100 bg-opacity-50 p-8'>
          <TypographyHeadline content={service.title} size='xl' />
          <p className='mt-4 font-mono md:text-lg'>{service.summary}</p>
        </div>
      </div>
        ...
        <PageContainer>
          <main className='p-4'>
            <article className='mx-auto w-full max-w-4xl'>
              <TypographyProse content={service.content} />
            </article>
            ...
            {service.gallery && service.gallery.length > 0 && (
              <GalleryBlock
                ...
                data={{
                  ...
                  gallery_items: service.gallery as any,
                }}
              />
            )}
          </main>
            ...
            <div className='flex-shrink-0 space-y-8 rounded-bl-2xl rounded-tr-2xl border-2 border-accent p-4 md:w-[300px]'>
              {service.client && (
                <div>
                  ...
                  <p className='font-mono font-bold '>{service.client}</p>
                </div>
              )}
              ...
              {service.built_with && (
                <div>
                  ...
                  {service.built_with.map((item, itemIdx) => (
              ...
              {service.cost && (
                <div>
                  ...
                  <p className='font-mono font-bold '>{service.cost}</p>
                </div>
              )}
            </div>
          </aside>
